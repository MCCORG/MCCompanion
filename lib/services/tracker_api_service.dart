  ...
  static Future<TrackerData?> getServers() async {
    try {
      ...
      if (res.statusCode == 200) {
        ...
        return TrackerData(
          servers: list
              .map((e) => TrackedServer.fromJson(e as Map<String, dynamic>))
              .toList(),
  ...
  static Future<({TrackedServer? server, String? error})> addServer({
    ...
    try {
      ...
      if (res.statusCode == 201) {
        final server = TrackedServer.fromJson(
      ...
      return (
        server: null,
        error: body['message'] as String? ?? 'unknown_error',
      );
    } catch (_) {
