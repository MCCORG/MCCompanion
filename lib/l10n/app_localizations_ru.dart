...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get startDirectMode => 'Запустить прямой режим';

  @override
  String get howToDirectTitle => 'Прямой режим';
  ...
  String get directNoResourcePack =>
      'Наборы ресурсов не работают в прямом режиме.';

  @override
  String directAddressNotSupported(String host) {
    return '$host — это адрес IPv6. Прямой режим поддерживает только IPv4. Используйте адрес IPv4 или имя хоста.';
  }
}
