...
class AppLocalizationsHi extends AppLocalizations {
  ...
  @override
  String get startDirectMode => 'डायरेक्ट मोड शुरू करें';

  @override
  String get howToDirectTitle => 'डायरेक्ट मोड';
  ...
  String get directNoResourcePack =>
      'डायरेक्ट मोड में रिसोर्स पैक काम नहीं करते।';

  @override
  String directAddressNotSupported(String host) {
    return '$host एक IPv6 पता है। डायरेक्ट मोड केवल IPv4 का समर्थन करता है। IPv4 पता या होस्टनाम इस्तेमाल करें।';
  }
}
